...
| [mongo-client](./mongo-client) | High-level MongoDB client wrapper with CRUD helpers and transactions | v0.3.0 | `go get github.com/isimtekin/go-packages/mongo-client@v0.3.0` |
...
| [crypto-utils](./crypto-utils) | Comprehensive cryptography utilities with AES, RSA, ECDSA, ECDH, hashing, and key derivation | v1.0.0 | `go get github.com/isimtekin/go-packages/crypto-utils@v1.0.0` |
...
- 📧 Multi-provider email sending (SendGrid, SMTP, AWS SES)
- 🔀 SenderManager for using multiple providers simultaneously
...
- ✅ 83.7% test coverage with comprehensive tests
...
- 🔗 Connection pooling with pgxpool for high performance
- 🔄 Transaction support with automatic commit/rollback
- 📦 Batch operations for efficient bulk queries
- 📥 COPY protocol support for fast bulk inserts
- 🛡️ PostgreSQL error helpers (unique violation, foreign key, etc.)
- 🏥 Health checks and connection pool statistics
- ⚙️ Functional options pattern for flexible configuration
- 🌐 Environment variable configuration with custom prefixes
